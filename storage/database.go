...
func (d *Database) Connect() error {
	d.log.Info("Connection to database", zap.String("url", d.createDataSourceName(false)))
	...
	d.log.Debug("setting connection pool options", zap.Int("max open connections", d.maxOpenConnections),
